# Лекция 7. Делегаты, события, лямбда-выражения, LINQ

[← Лекция 6](Лекция%206.%20Работа%20со%20строками.md) | [Оглавление](../../README.md) | [Практическая работа 1 →](Практическая%20работа%201.%20Компиляция%20и%20запуск%20.NET%20приложения.md)
