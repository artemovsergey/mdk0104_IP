...
[← Практическая работа 19](Практическая%20работа%2019.%20Паттерн%20Репозиторий.md) | [Оглавление](../../README.md) | [Практическая работа 21 →](Практическая%20работа%2021.%20CRUD-операции%20с%20EF.md)
...
> **Важно! Инструмент EF Core CLI.** Если команда `dotnet ef` недоступна, установите инструмент: `dotnet tool install --global dotnet-ef --version 10.0.12`.
