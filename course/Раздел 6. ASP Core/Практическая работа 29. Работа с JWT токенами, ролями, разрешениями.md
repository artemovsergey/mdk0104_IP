...
[← Практическая работа 28](Практическая%20работа%2028.%20Разработка%20приложения%20Blazor.md) | [Оглавление](../../README.md) | [Практическая работа 30 →](Практическая%20работа%2030.%20Фоновые%20задачи.%20Hangfire.md)
...
2. Добавить пакеты для работы с JWT:
...
3. Добавить модель пользователя и роли.
4. Настроить сервис генерации JWT токенов.
5. Создать контроллер для регистрации и логина пользователей.
6. Настроить политики авторизации и роли.
7. Реализовать защищенные эндпоинты с проверкой JWT и ролей.
8. Проверить работу с помощью Postman или Swagger.
9. Сделать скриншоты работы приложения.
10. Создать репозиторий:
