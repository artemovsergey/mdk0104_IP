...
- Практическая работа 11: Использование Task и async/await

- Лекцию 13 Параллельное программирование: Parallel.For, Parallel.ForEach, PLINQ
- Практическая работа 12. Приминение параллельных вычислений


- Самостоятельная работа 3. Разрешение проблем гонки данных

# Модуль 4. Обработка файлов
...
# Модуль 5. Работа с базами данных. Entity Framework Core
...
- Практическая работа 20: Создание модели данных в EF Core
- Практическая работа 21: CRUD-операции с EF Core
...
- Лекция 23. Архитектурные стили приложений .NET   
